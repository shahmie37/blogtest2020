...
public class EntryDTO implements Serializable {
    ...
    private boolean blogIsPositive;
    ...
    public boolean getBlogIsPositive() {
        return blogIsPositive;
    }

    public void setBlogIsPositive(boolean blogIsPositive) {
        this.blogIsPositive = blogIsPositive;
    }
    ...
    public String toString() {
        return "EntryDTO{" +
            ...
            ", blogIsPositive='" + getBlogIsPositive() + "'" +
            "}";
    }
}
